...
class TestPyMdStat(unittest.TestCase):
    ...
    def test_099_model(self):
        i = 4
        mdstat_test = MdStat('./tests/mdstat.0%s' % i)
        self.assertItemsEqual(mdstat_test.personalities(), ['raid1', 'raid6', 'raid5', 'raid4'])
        self.assertItemsEqual(mdstat_test.arrays(), ['md2', 'md3', 'md0', 'md1'])
        ...
        self.assertItemsEqual(mdstat_test.components('md3'), ['sdk1', 'sdj1', 'sde1', 'sdl1', 'sdg1', 'sdf1', 'sdh1', 'sdc1', 'sdd1', 'sdi1'])
    ...
    def test_002(self):
        i = 2
        mdstat_test = MdStat('./tests/mdstat.0%s' % i)
        self.assertItemsEqual(mdstat_test.get_stats()['personalities'], ['raid1', 'raid6', 'raid5', 'raid4'])
    ...
    def test_003(self):
        i = 3
        mdstat_test = MdStat('./tests/mdstat.0%s' % i)
        self.assertItemsEqual(mdstat_test.get_stats()['personalities'], ['raid6', 'raid5', 'raid4'])
    ...
    def test_006(self):
        i = 6
        mdstat_test = MdStat('./tests/mdstat.0%s' % i)
        self.assertItemsEqual(mdstat_test.get_stats()['personalities'], ['linear', 'raid0', 'raid1', 'raid5', 'raid4', 'raid6'])
